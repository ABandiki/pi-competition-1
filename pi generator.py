...
print(" how?? because the probability that two numbers are co-prime is 6/(pi)^2")
import random
import math
itera = 0
...
while(does >= itera):
    ...
    if (0 <= r1border < 0.000001):
        ...
        r1 = int((r1b*100)//1)
    elif (0.000001 <= r1border < 0.000100):
        r1 = int((r1b*1000)//1)
    elif (0.000001 <= r1border < 0.001000):
        r1 = int((r1b*10000)//1)
    elif (0.000001 <= r1border < 0.010000):
        r1 = int((r1b*100000)//1)
    elif (0.000001 <= r1border < 0.100000):
